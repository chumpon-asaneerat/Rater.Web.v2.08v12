...
const RaterWebv2x08r12 = class extends SqlServer {
    ...
    async GetPeriodUnit(pObj) {
        let name = 'GetPeriodUnit';
        let proc = schema[name];
        return await this.execute(name, pObj, proc.parameter.inputs, proc.parameter.outputs);
    }
    ...
    async GetLimitUnit(pObj) {
        let name = 'GetLimitUnit';
        let proc = schema[name];
        return await this.execute(name, pObj, proc.parameter.inputs, proc.parameter.outputs);
    }
    ...
    async GetMemberType(pObj) {
        let name = 'GetMemberType';
        let proc = schema[name];
        return await this.execute(name, pObj, proc.parameter.inputs, proc.parameter.outputs);
    }
    ...
    async GetDeviceType(pObj) {
        let name = 'GetDeviceType';
        let proc = schema[name];
        return await this.execute(name, pObj, proc.parameter.inputs, proc.parameter.outputs);
    }
    ...
    async GetCustomer(pObj) {
        let name = 'GetCustomer';
        let proc = schema[name];
        return await this.execute(name, pObj, proc.parameter.inputs, proc.parameter.outputs);
    }
    ...
    async GetMemberInfo(pObj) {
        let name = 'GetMemberInfo';
        let proc = schema[name];
        return await this.execute(name, pObj, proc.parameter.inputs, proc.parameter.outputs);
    }
    ...
    async GetQSlideItem(pObj) {
        let name = 'GetQSlideItem';
        let proc = schema[name];
        return await this.execute(name, pObj, proc.parameter.inputs, proc.parameter.outputs);
    }
