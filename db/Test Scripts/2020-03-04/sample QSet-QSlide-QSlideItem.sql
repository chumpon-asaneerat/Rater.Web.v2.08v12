/*
EXEC GetQSetByDate N'EN', N'EDL-C2019100004', N'2020-01-13', N'2020-01-13'
SELECT * FROM QSet WHERE CustomerId = N'EDL-C2019100004'
SELECT * FROM QSlide WHERE CustomerId = N'EDL-C2019100004'
SELECT * FROM QSlideItem WHERE CustomerId = N'EDL-C2019100004'
*/

DECLARE @errNum int;
DECLARE @errMsg nvarchar(max);
declare @customerId nvarchar(30) = N'EDL-C2019100004'
...
/*
EXEC GetQSlides N'EN', N'EDL-C2019100004', N'QS00004'
EXEC GetQSlideItems N'EN', N'EDL-C2019100004', N'QS00004', 1, NULL
EXEC GetOrgs N'EN', N'EDL-C2019100004'
EXEC GetDevices N'EN', N'EDL-C2019100004'

EXEC SaveVote N'EDL-C2019100004', N'orgId', N'deviceId', N'qsetId', @qseq, N'userId', N'votedate', @voteValue
*/
...
EXEC GetMemberInfos NULL, @customerId
*/
