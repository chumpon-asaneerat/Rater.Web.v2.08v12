...
riot.tag2('statusbar', '<div class="statusbar-container"> <yield></yield> </div>', 'statusbar,[data-is="statusbar"]{ position: absolute; display: block; margin: 0; padding: 0; bottom: 0; width: 100%; user-select: none; white-space: nowrap; overflow: hidden; } statusbar>.statusbar-container,[data-is="statusbar"]>.statusbar-container{ position: relative; margin: 0; padding: 0; width: 100%; }', '', function(opts) {
});
