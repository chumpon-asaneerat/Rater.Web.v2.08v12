...
riot.tag2('card-container', '<div class="card-container-wrapper"> <yield></yield> </div>', 'card-container,[data-is="card-container"]{ position: relative; display: grid; grid-template-columns: 1fr; grid-template-rows: 1fr; grid-template-areas: \'card-container-area\'; margin: 0; padding: 5px; padding-right: 10px; width: 100%; height: 100%; } card-container>.card-container-wrapper,[data-is="card-container"]>.card-container-wrapper{ grid-area: card-container-area; position: relative; margin: 0; padding: 0; width: 100%; height: 100%; } card-container[shadow]>.card-container-wrapper,[data-is="card-container"][shadow]>.card-container-wrapper{ border: 1px solid #EEEEEE; box-shadow: var(--card-box-shadow); }', '', function(opts) {
});
riot.tag2('card-item', '<div> <yield></yield> </div>', 'card-item,[data-is="card-item"]{ position: relative; display: inline-block; margin: 0 auto; padding: 0; }', '', function(opts) {
});
riot.tag2('card-row', '<div class="card-row-wrapper"> <yield></yield> </div>', 'card-row,[data-is="card-row"]{ position: relative; display: grid; grid-template-columns: 1fr; grid-template-rows: 1fr; grid-template-areas: \'card-row-area\'; margin: 0; padding: 5px; padding-right: 10px; width: 100%; height: auto; overflow: hidden; } card-row>.card-row-wrapper,[data-is="card-row"]>.card-row-wrapper{ grid-area: card-row-area; position: absolute; display: flex; flex-wrap: wrap; justify-content: space-between; margin: 0 auto; padding: 0; width: 100%; } card-row[shadow]>.card-row-wrapper,[data-is="card-row"][shadow]>.card-row-wrapper{ border: 1px solid #EEEEEE; box-shadow: var(--card-box-shadow); }', '', function(opts) {
});
