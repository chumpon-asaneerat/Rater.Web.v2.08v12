...
riot.tag2('groupheaders', '', '', '', function(opts) {
});
riot.tag2('grouppage', '', '', '', function(opts) {
});
riot.tag2('grouppages', '', '', '', function(opts) {
});
riot.tag2('nfilter', '<div class="input-container"> <span ref="input" class="input" riot-value="{opts.value}" contenteditable></span> <div ref="clear" class="clear"><span class="fas fa-times"></span></div> <label>{opts.title}</label> </div>', 'nfilter,[data-is="nfilter"]{ position: relative; display: grid; margin: 0 auto; padding: 0; grid-template-columns: 3px 1fr 3px; grid-template-rows: 3px auto 3px; grid-template-areas: \'. . .\' \'. input-ares .\' \'. . .\'; height: auto; width: 100%; background: transparent; } nfilter>.input-container,[data-is="nfilter"]>.input-container{ grid-area: input-ares; position: relative; display: grid; grid-template-columns: 2px 5px 1fr 5px 20px 2px; grid-template-rows: 5px 1.7rem auto 5px; grid-template-areas: \'. . . . . .\' \'. . . . . .\' \'. . ctrl . clear .\' \'. . . . . .\'; margin: 0; padding: 0; height: auto; width: 100%; } nfilter>.input-container>.input,[data-is="nfilter"]>.input-container>.input{ grid-area: ctrl; display: inline-block; margin: 0; padding: 0 5px; padding-bottom: 5px; width: 100%; background-color: transparent; box-sizing: border-box; box-shadow: none; outline: none; border: none; box-shadow: 0 0 0px 1000px white inset; border-bottom: 2px solid #999; } nfilter>.input-container>.clear,[data-is="nfilter"]>.input-container>.clear{ grid-area: clear; display: flex; margin: 0 auto; margin-top: 4px; padding: 0px 3px; align-items: center; justify-items: center; font-weight: bold; font-size: .7rem; width: 18px; height: 18px; color: silver; cursor: pointer; user-select: none; } nfilter>.input-container>.clear:hover,[data-is="nfilter"]>.input-container>.clear:hover{ color: red; } nfilter>.input-container>.clear:hover,[data-is="nfilter"]>.input-container>.clear:hover{ color: red; } nfilter>.input-container>.input:-webkit-autofill,[data-is="nfilter"]>.input-container>.input:-webkit-autofill,nfilter>.input-container>.input:-webkit-autofill:hover,[data-is="nfilter"]>.input-container>.input:-webkit-autofill:hover,nfilter>.input-container>.input:-webkit-autofill:focus,[data-is="nfilter"]>.input-container>.input:-webkit-autofill:focus{ transition: background-color 5000s ease-in-out 0s; } nfilter>.input-container>label,[data-is="nfilter"]>.input-container>label{ position: absolute; top: 2rem; left: 14px; color: #555; transition: .2s; pointer-events: none; } nfilter>.input-container>.input:focus ~ label,[data-is="nfilter"]>.input-container>.input:focus ~ label{ top: .25rem; left: 10px; color: #f7497d; font-weight: bold; } nfilter>.input-container>.input:-webkit-autofill ~ label,[data-is="nfilter"]>.input-container>.input:-webkit-autofill ~ label,nfilter>.input-container>.input:valid ~ label,[data-is="nfilter"]>.input-container>.input:valid ~ label{ top: .25rem; left: 10px; color: cornflowerblue; font-weight: bold; } nfilter>.input-container>.input:focus,[data-is="nfilter"]>.input-container>.input:focus{ background-color: #999; border-bottom: 2px solid #f7497d; } nfilter>.input-container>.input:valid,[data-is="nfilter"]>.input-container>.input:valid{ border-bottom: 2px solid cornflowerblue; }', '', function(opts) {
});
...
riot.tag2('ntree', '', '', '', function(opts) {
});
riot.tag2('ntree1', '<div class="ntree-container"> <div ref="tree" class="tree"></div> </div> <label>{opts.title}</label>', 'ntree1,[data-is="ntree1"]{ margin: 0; margin-top: 5px; padding: 10px; font-size: 14px; display: inline-block; position: relative; height: auto; width: 100%; background: transparent; box-shadow: 0 5px 10px solid rgba(0, 0, 0, .2); } ntree1 .ntree-container,[data-is="ntree1"] .ntree-container{ display: block; padding: 20px 0 10px 0; margin-bottom: 0px; width: calc(100% - 25px); background-color: whitesmoke; box-sizing: border-box; box-shadow: none; outline: none; border: none; font-size: 14px; box-shadow: 0 0 0px 1000px white inset; border-radius: 2px; border-bottom: 2px solid cornflowerblue; overflow: hidden; } ntree1 .ntree-container .tree,[data-is="ntree1"] .ntree-container .tree{ width: 100%; border: 1px solid silver; border-radius: 2px; height: 100px; min-height: 100px; max-height: 100px; overflow: auto; } ntree1 label,[data-is="ntree1"] label{ position: absolute; top: 5px; left: 10px; transition: .2s; pointer-events: none; color: cornflowerblue; font-weight: bold; }', '', function(opts) {
...
riot.tag2('slide-browser', '', '', '', function(opts) {
});
riot.tag2('slide-preview', '', '', '', function(opts) {
});
...
riot.tag2('button-properties-editor', '', '', '', function(opts) {
});
...
riot.tag2('password-textbox', '', '', '', function(opts) {
});

riot.tag2('username-textbox', '', '', '', function(opts) {
});
