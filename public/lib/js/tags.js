...
riot.tag2('card-item', '<div class="card-item-wrapper"> <yield></yield> </div>', 'card-item,[data-is="card-item"]{ position: relative; display: inline-block; margin: 0; padding: 2px; padding-bottom: 15px; } card-item>.card-item-wrapper,[data-is="card-item"]>.card-item-wrapper{ position: relative; display: block; margin: 0 auto; padding: 5px; width: 100%; height: 100%; } card-item[shadow]>.card-item-wrapper,[data-is="card-item"][shadow]>.card-item-wrapper{ border: 1px solid #EEEEEE; box-shadow: var(--card-box-shadow); }', '', function(opts) {
});
