...
riot.tag2('screen', '<div class="content-area"> <yield></yield> </div>', 'screen,[data-is="screen"]{ margin: 0 auto; padding: 0; display: none; width: 100%; height: 100%; } screen.active,[data-is="screen"].active,screen.show,[data-is="screen"].show{ display: grid; grid-template-columns: 1fr; grid-template-rows: 1fr; grid-template-areas: \'content-area\'; } screen .content-area,[data-is="screen"] .content-area{ grid-area: content-area; position: relative; display: grid; grid-template-columns: auto 1fr auto; grid-template-rows: 1fr; grid-template-areas: \'sidebar-left content-body sidebar-right\'; margin: 0; padding: 0; width: 100%; height: 100%; overflow: hidden; } screen .content-area sidebar[position="left"],[data-is="screen"] .content-area sidebar[position="left"]{ grid-area: sidebar-left; margin: 0; padding: 0; top: 0; left: 0; bottom: 0; width: 300px; height: 100%; } screen .content-area sidebar[position="right"],[data-is="screen"] .content-area sidebar[position="right"]{ grid-area: sidebar-right; margin: 0; padding: 0; top: 0; right: 0; bottom: 0; width: 300px; height: 100%; } screen .content-area sidebar[position="left"][mode="float"],[data-is="screen"] .content-area sidebar[position="left"][mode="float"]{ position: absolute; width: 50px; background-color: aqua; } screen .content-area sidebar[position="left"][mode="float"]:hover,[data-is="screen"] .content-area sidebar[position="left"][mode="float"]:hover{ position: absolute; margin: 0; padding: 0; top: 0; left: 0; bottom: 0; width: 250px; background-color: aqua; } screen .content-area .content-body,[data-is="screen"] .content-area .content-body{ grid-area: content-body; margin: 0; padding: 0; height: 100%; }', '', function(opts) {
        let self = this
...
riot.tag2('language-menu', '', 'language-menu,[data-is="language-menu"]{ margin: 0 auto; }', '', function(opts) {
...
riot.tag2('screen1', '<yield></yield> <button onclick="{gotoScreen2}">Goto Screen 2</button>', 'screen1,[data-is="screen1"]{ margin: 0 auto; padding: 0; width: 100%; height: 100%; }', '', function(opts) {
        let self = this
        let scrId = 'screen1'
