...
riot.tag2('card-row', '<div class="card-row-wrapper"> <div class="card-row-area"> <yield></yield> </div> </div>', 'card-row,[data-is="card-row"]{ position: relative; display: grid; grid-template-columns: 1fr; grid-template-rows: 1fr; grid-template-areas: \'card-row-area\'; margin: 0; padding: 5px; padding-right: 10px; width: 100%; } card-row>.card-row-wrapper,[data-is="card-row"]>.card-row-wrapper{ grid-area: card-row-area; position: relative; display: block; margin: 0 auto; padding: 0; width: 100%; background-color: aqua; } card-row[shadow]>.card-row-wrapper,[data-is="card-row"][shadow]>.card-row-wrapper{ border: 1px solid #EEEEEE; box-shadow: var(--card-box-shadow); } card-row>.card-row-wrapper>.card-row-area,[data-is="card-row"]>.card-row-wrapper>.card-row-area{ position: relative; margin: 0 auto; padding: 0; width: 100%; }', '', function(opts) {
});
