...
riot.tag2('sidebar', '<div class="sidebar-container"> <yield></yield> </div>', 'sidebar,[data-is="sidebar"]{ position: relative; display: grid; grid-template-columns: auto; grid-template-rows: 1fr; grid-template-areas: \'sidebar-area\'; margin: 0; padding: 0; width: var(--sidebar-width); height: 100%; z-index: 99999; overflow: hidden; } sidebar:empty,[data-is="sidebar"]:empty{ display: none; } sidebar>.sidebar-container,[data-is="sidebar"]>.sidebar-container{ grid-area: sidebar-area; position: relative; display: block; margin: 0 auto; padding: 0; width: 100%; height: 100%; overflow: auto; } @media only screen and (max-width: 600px) { } @media only screen and (min-width: 600px) { } @media only screen and (min-width: 992px) { } @media only screen and (min-width: 1200px) { }', '', function(opts) {
        let self = this
