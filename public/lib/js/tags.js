...
riot.tag2('statusbar', '<div class="statusbar-container"> <yield></yield> </div>', 'statusbar,[data-is="statusbar"]{ position: relative; display: block; margin: 0; padding: 0; width: 100%; user-select: none; white-space: nowrap; overflow: hidden; } statusbar>.statusbar-container,[data-is="statusbar"]>.statusbar-container{ position: relative; display: block; margin: 0; padding: 0; width: 100%; height: fit-content; }', '', function(opts) {
});
