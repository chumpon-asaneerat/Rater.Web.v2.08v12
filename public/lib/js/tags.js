...
riot.tag2('card-container', '<div class="card-container-wrapper"> <yield></yield> </div>', 'card-container,[data-is="card-container"]{ position: relative; display: grid; grid-template-columns: 1fr; grid-template-rows: 1fr; grid-template-areas: \'card-container-area\'; margin: 0; padding: 5px; padding-right: 10px; width: 100%; height: 100%; overflow: hidden; } card-container>.card-container-wrapper,[data-is="card-container"]>.card-container-wrapper{ grid-area: card-container-area; position: absolute; margin: 0; padding: 0; width: 100%; height: 100%; overflow: hidden; overflow-y: auto; } card-container[shadow]>.card-container-wrapper,[data-is="card-container"][shadow]>.card-container-wrapper{ border: 1px solid #EEEEEE; box-shadow: var(--card-box-shadow); }', '', function(opts) {
});
riot.tag2('card-item', '<div class="card-item-wrapper"> <yield></yield> </div>', 'card-item,[data-is="card-item"]{ position: relative; display: inline-block; margin: 3px; padding: 3px; border: 1px solid #EEEEEE; box-shadow: var(--card-box-shadow); } card-item>.card-item-wrapper,[data-is="card-item"]>.card-item-wrapper{ position: relative; display: block; margin: 0 auto; padding: 0; width: 100%; height: 100%; } card-item[shadow]>.card-item-wrapper,[data-is="card-item"][shadow]>.card-item-wrapper{ border: 1px solid #EEEEEE; box-shadow: var(--card-box-shadow); }', '', function(opts) {
});
riot.tag2('card-row', '<div class="card-row-wrapper"> <div class="card-row-area"> <yield></yield> </div> </div>', 'card-row,[data-is="card-row"]{ position: relative; display: grid; grid-template-columns: 1fr; grid-template-rows: 1fr; grid-template-areas: \'card-row-area\'; margin: 0; padding: 5px; padding-right: 10px; width: 100%; height: auto; } card-row>.card-row-wrapper,[data-is="card-row"]>.card-row-wrapper{ grid-area: card-row-area; position: relative; display: block; margin: 0 auto; padding: 0; width: 100%; height: auto; } card-row[shadow]>.card-row-wrapper,[data-is="card-row"][shadow]>.card-row-wrapper{ border: 1px solid #EEEEEE; box-shadow: var(--card-box-shadow); } card-row>.card-row-wrapper>.card-row-area,[data-is="card-row"]>.card-row-wrapper>.card-row-area{ position: relative; margin: 0 auto; padding: 0; width: 100%; height: auto; }', '', function(opts) {
});
