...
riot.tag2('sidebar', '<div class="sidebar-area"> <yield></yield> </div>', 'sidebar,[data-is="sidebar"]{ position: relative; display: none; margin: 0; padding: 0; height: 100%; border: 1px solid silver; z-index: 99999; } sidebar.show,[data-is="sidebar"].show,sidebar.active,[data-is="sidebar"].active{ display: inline-block; position: absolute; } sidebar.pin.show,[data-is="sidebar"].pin.show,sidebar.pin.active,[data-is="sidebar"].pin.active{ position: relative; } @media only screen and (max-width: 400px) { sidebar.show,[data-is="sidebar"].show,sidebar.active,[data-is="sidebar"].active{ position: absolute; } sidebar.pin.show,[data-is="sidebar"].pin.show,sidebar.pin.active,[data-is="sidebar"].pin.active{ position: relative; } } @media only screen and (max-width: 700px) { sidebar.show,[data-is="sidebar"].show,sidebar.active,[data-is="sidebar"].active{ position: absolute; } sidebar.pin.show,[data-is="sidebar"].pin.show,sidebar.pin.active,[data-is="sidebar"].pin.active{ position: relative; } } sidebar>.sidebar-area,[data-is="sidebar"]>.sidebar-area{ position: relative; margin: 0 auto; padding: 0; width: var(--sidebar-width); height: 100%; overflow: auto; } sidebar>.sidebar-area:empty,[data-is="sidebar"]>.sidebar-area:empty{ display: none; } sidebar.c1,[data-is="sidebar"].c1{ background-color: burlywood; } sidebar.c2,[data-is="sidebar"].c2{ background-color: aliceblue; } sidebar.c3,[data-is="sidebar"].c3{ background-color: cornsilk; }', '', function(opts) {
        let self = this
        let addEvt = events.doc.add, delEvt = events.doc.remove
...
riot.tag2('rater-web-app', '<napp> <sidebar> <div> <h6>Sidebar Left</h6> </div> </sidebar> <sidebar> <div> <h6>Sidebar Left 2</h6> </div> </sidebar> <navibar> <navi-item> <sidebar-menu></sidebar-menu> </navi-item> <navi-item> <div class="banner"> <div class="status" mobile>1</div>&nbsp;&nbsp; <div class="caption" tablet>My Choice Rater Web{(content && content.title) ? \'&nbsp;-&nbsp;\' : \'&nbsp;\'}</div> <div class="title " notebook>{(content && content.title) ? \'- \' + content.title : \'- Title\'}</div> <div class="title " widescreen>[notebook]</div> </div> </navi-item> <navi-item class="center"></navi-item> <navi-item class="right"> <language-menu></language-menu> </navi-item> <navi-item class="right"> <links-menu></links-menu> </navi-item> </navibar> <navibar> <div class="banner"> <div class="caption">Second Nav bar</div> </div> </navibar> <yield></yield> <statusbar> <span class="copyright">EDL Co., Ltd.</span> </statusbar> <statusbar> <span class="copyright">Second EDL Co., Ltd.</span> </statusbar> </napp>', 'rater-web-app,[data-is="rater-web-app"]{ position: relative; display: block; margin: 0; padding: 0; width: auto; height: auto; overflow: hidden; } rater-web-app .banner>.status,[data-is="rater-web-app"] .banner>.status{ position: relative; display: inline-block; margin: 0 auto; padding: 0; white-space: nowrap; overflow: hidden; text-align: center; text-overflow: ellipsis; font-size: 0.8rem; height: 0.8rem; line-height: 0.8rem; width: 1rem; color: white; background-color: forestgreen; border-radius: 50%; } rater-web-app .banner>.title,[data-is="rater-web-app"] .banner>.title{ position: relative; display: inline-block; margin: 0; padding: 0; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; font-size: 1.2rem; line-height: 1rem; } rater-web-app .banner>.caption,[data-is="rater-web-app"] .banner>.caption{ position: relative; display: inline-block; margin: 0; padding: 0; width: auto; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; font-size: 1.2rem; line-height: 1rem; } @media only screen and (max-width: 400px) { rater-web-app .banner>*[mobile],[data-is="rater-web-app"] .banner>*[mobile]{ display: none !important; } rater-web-app .banner>*[tablet],[data-is="rater-web-app"] .banner>*[tablet]{ display: none; } } @media only screen and (max-width: 550px) { rater-web-app .banner>*[mobile],[data-is="rater-web-app"] .banner>*[mobile]{ display: none !important; } rater-web-app .banner>*[notebook],[data-is="rater-web-app"] .banner>*[notebook]{ display: none; } } @media only screen and (max-width: 800px) { rater-web-app .banner>*[mobile],[data-is="rater-web-app"] .banner>*[mobile]{ display: none !important; } rater-web-app .banner>*[widescreen],[data-is="rater-web-app"] .banner>*[widescreen]{ display: none; } } @media only screen and (max-width: 1000px) { } rater-web-app language-menu,[data-is="rater-web-app"] language-menu{ position: relative; display: flex; margin: 0 auto; padding: 0; align-items: center; justify-content: stretch; } rater-web-app links-menu,[data-is="rater-web-app"] links-menu{ position: relative; display: flex; margin: 0 auto; padding: 0; align-items: center; justify-content: stretch; } rater-web-app .copyright,[data-is="rater-web-app"] .copyright{ position: relative; margin: 0; padding: 0; font-size: .5em; color: black; }', '', function(opts) {
