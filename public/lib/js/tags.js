...
riot.tag2('napp', '<div class="app-area"> <yield></yield> </div>', 'napp,[data-is="napp"]{ display: grid; margin: 0 auto; padding: 0; height: 100vh; width: 100vw; grid-template-areas: \'app-area\'; background: inherit; overflow: hidden; } napp>.app-area,[data-is="napp"]>.app-area{ grid-area: app-area; position: relative; display: grid; grid-template-columns: auto 1fr; grid-template-rows: auto 1fr auto; grid-template-areas: \'navi-area navi-area\' \'sidebar-area scrn-area\' \'sidebar-area stat-area\'; margin: 0; padding: 0; width: 100%; height: 100%; overflow: hidden; } napp>.app-area>:not(sidebar):not(navibar):not(screen):not(statusbar),[data-is="napp"]>.app-area>:not(sidebar):not(navibar):not(screen):not(statusbar){ display: none; } napp>.app-area sidebar:nth-of-type(1),[data-is="napp"]>.app-area sidebar:nth-of-type(1){ grid-area: sidebar-area; position: relative; } napp>.app-area sidebar:not(:nth-of-type(1)),[data-is="napp"]>.app-area sidebar:not(:nth-of-type(1)){ grid-area: sidebar-area; display: none; } napp>.app-area navibar:nth-of-type(1),[data-is="napp"]>.app-area navibar:nth-of-type(1){ grid-area: navi-area; position: relative; } napp>.app-area navibar:not(:nth-of-type(1)),[data-is="napp"]>.app-area navibar:not(:nth-of-type(1)){ grid-area: navi-area; display: none; } napp>.app-area screen,[data-is="napp"]>.app-area screen{ grid-area: scrn-area; position: relative; } napp>.app-area statusbar:last-of-type(1),[data-is="napp"]>.app-area statusbar:last-of-type(1){ grid-area: stat-area; position: relative; } napp>.app-area statusbar:not(:last-of-type(1)),[data-is="napp"]>.app-area statusbar:not(:last-of-type(1)){ grid-area: stat-area; display: none; }', '', function(opts) {
});
