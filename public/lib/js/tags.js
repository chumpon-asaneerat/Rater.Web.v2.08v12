...
riot.tag2('napp', '<div class="app-area"> <yield></yield> </div>', 'napp,[data-is="napp"]{ display: grid; margin: 0 auto; padding: 0; height: 100vh; width: 100vw; grid-template-areas: \'app-area\'; background: inherit; overflow: hidden; } napp>.app-area,[data-is="napp"]>.app-area{ grid-area: app-area; position: relative; display: grid; grid-template-columns: auto 1fr; grid-template-rows: auto 1fr auto; grid-template-areas: \'navi-area navi-area\' \'sidebar-area scrn-area\' \'sidebar-area stat-area\'; margin: 0; padding: 0; width: 100%; height: 100%; overflow: hidden; } napp>.app-area>:not(sidebar):not(navibar):not(screen):not(statusbar),[data-is="napp"]>.app-area>:not(sidebar):not(navibar):not(screen):not(statusbar){ display: none; } napp>.app-area sidebar:nth-of-type(1),[data-is="napp"]>.app-area sidebar:nth-of-type(1){ grid-area: sidebar-area; position: relative; } napp>.app-area sidebar:nth-of-type(1):empty,[data-is="napp"]>.app-area sidebar:nth-of-type(1):empty{ grid-area: sidebar-area; display: none; } napp>.app-area sidebar:not(:nth-of-type(1)),[data-is="napp"]>.app-area sidebar:not(:nth-of-type(1)){ grid-area: sidebar-area; display: none; } napp>.app-area navibar:nth-of-type(1),[data-is="napp"]>.app-area navibar:nth-of-type(1){ grid-area: navi-area; position: relative; } napp>.app-area navibar:nth-of-type(1):empty,[data-is="napp"]>.app-area navibar:nth-of-type(1):empty{ grid-area: navi-area; display: none; } napp>.app-area navibar:not(:nth-of-type(1)),[data-is="napp"]>.app-area navibar:not(:nth-of-type(1)){ grid-area: navi-area; display: none; } napp>.app-area screen,[data-is="napp"]>.app-area screen{ grid-area: scrn-area; } napp>.app-area statusbar:last-of-type(1),[data-is="napp"]>.app-area statusbar:last-of-type(1){ grid-area: stat-area; } napp>.app-area statusbar:nth-of-type(1):empty,[data-is="napp"]>.app-area statusbar:nth-of-type(1):empty{ grid-area: stat-area; display: none; } napp>.app-area statusbar:not(:last-of-type(1)),[data-is="napp"]>.app-area statusbar:not(:last-of-type(1)){ grid-area: stat-area; display: none; }', '', function(opts) {
});
...
riot.tag2('sidebar', '<div class="sidebar-container"> <yield></yield> </div>', 'sidebar,[data-is="sidebar"]{ position: relative; display: none; margin: 0; padding: 0; width: auto; height: 100%; border: 1px solid silver; z-index: 99999; overflow: hidden; } sidebar.show,[data-is="sidebar"].show,sidebar.active,[data-is="sidebar"].active{ display: inline-block; position: absolute; } @media only screen and (max-width: 700px) { sidebar.show,[data-is="sidebar"].show,sidebar.active,[data-is="sidebar"].active{ display: inline-block; position: absolute; } } sidebar .sidebar-container,[data-is="sidebar"] .sidebar-container{ position: absolute; margin: 0 auto; padding: 0; width: var(--sidebar-width); height: 100%; overflow: auto; } sidebar .sidebar-container:empty,[data-is="sidebar"] .sidebar-container:empty{ display: none; } sidebar.c1,[data-is="sidebar"].c1{ background-color: burlywood; } sidebar.c2,[data-is="sidebar"].c2{ background-color: aliceblue; } sidebar.c3,[data-is="sidebar"].c3{ background-color: cornsilk; }', '', function(opts) {
        let self = this
        let addEvt = events.doc.add, delEvt = events.doc.remove
