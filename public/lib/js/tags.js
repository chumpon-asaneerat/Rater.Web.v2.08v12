...
riot.tag2('sidebar', '<div class="sidebar-area"> <yield></yield> </div>', 'sidebar,[data-is="sidebar"]{ position: relative; display: none; margin: 0; padding: 0; height: 100%; border: 1px solid silver; z-index: 99999; } sidebar.show,[data-is="sidebar"].show,sidebar.active,[data-is="sidebar"].active{ display: block; position: relative; } sidebar.pin.show,[data-is="sidebar"].pin.show,sidebar.pin.active,[data-is="sidebar"].pin.active{ position: relative; } sidebar>.sidebar-area,[data-is="sidebar"]>.sidebar-area{ position: relative; display: block; margin: 0 auto; padding: 0; width: var(--sidebar-width); height: 100%; overflow: auto; } sidebar>.sidebar-area:empty,[data-is="sidebar"]>.sidebar-area:empty{ display: none; } @media only screen and (max-width: 600px) { sidebar.show,[data-is="sidebar"].show,sidebar.active,[data-is="sidebar"].active{ position: absolute; display: block; background-color: skyblue; } } @media only screen and (min-width: 600px) { sidebar.show,[data-is="sidebar"].show,sidebar.active,[data-is="sidebar"].active{ position: absolute; display: block; background-color: aquamarine; } sidebar>.sidebar-area,[data-is="sidebar"]>.sidebar-area{ width: var(--sidebar-collapse-width); } sidebar>.sidebar-area:hover,[data-is="sidebar"]>.sidebar-area:hover{ width: var(--sidebar-width); } } @media only screen and (min-width: 992px) { sidebar.show,[data-is="sidebar"].show,sidebar.active,[data-is="sidebar"].active{ position: absolute; display: block; background-color: antiquewhite; } sidebar>.sidebar-area,[data-is="sidebar"]>.sidebar-area{ width: var(--sidebar-width); } } @media only screen and (min-width: 1200px) { } sidebar.c1,[data-is="sidebar"].c1{ background-color: burlywood; } sidebar.c2,[data-is="sidebar"].c2{ background-color: aliceblue; } sidebar.c3,[data-is="sidebar"].c3{ background-color: cornsilk; }', '', function(opts) {
        let self = this
        let addEvt = events.doc.add, delEvt = events.doc.remove
